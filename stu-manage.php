...
<body>
	...
	?>
<div class="container">
<h4 class="p-3 mb-2 bg-primary text-white" style="text-align: center; padding-top: 10px">Manage Student</h4>


 <form class="row g-4" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  <div class="col-3">
   
   <h5 class="text-info">Student List</h5>
  </div>
  <div class="col-6">
...
if(isset($_POST['search'])){
	...
	$sql = "select * from sturegister where name like '%$text%' OR rollno like '$text'";
...
$i=1;
		...
		<td>".$row['branch']."</td>
		<td>".$row['semester']."</td>
		<td><a href='http://localhost/elective_management/admin-view.php?sid=".$row['rollno']."' <button>View</button></td>
		<td>".$value."</td>
	</tr>";
	$i++;
			}
...
<div style="text-align: center; padding-top: 20px">
		...
		<a href="admin-board.php"><button class="btn btn-primary">Back</button> </a>
	</div>
</div>
</body>
</html>